  ...
  return (
    <div className="w-full h-screen flex items-start justify-around">
      <div className="w-1/3 h-screen text-lg py-5 px-10 border-r-2 border-info">
        <h1 className="font-bold mb-10 flex items-center gap-1 text-center mx-auto w-28 ">
          <FaPen></FaPen>
          <span>メモ追加</span>
        </h1>
        <form className="flex flex-col gap-5 items-center ">
          ...
          <textarea
            ...
            placeholder="メモ"
          ></textarea>
          <button className="btn btn-info w-[300px] shadow-xl">
            <CgAdd />
            追加
          </button>
        </form>
      ...
      <div className="w-2/3 flex flex-col p-5">
        <h1 className="font-bold text-center mb-10 flex items-center mx-auto gap-1">
          <LuSwatchBook></LuSwatchBook>
          <span>メモ一覧</span>
        </h1>
        <input
          type="text"
